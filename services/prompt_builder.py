...
SYSTEM_PROMPT = (
    ...
    "IMPORTANT: Use newline characters (\\n) to separate the three lines. Do NOT put them on a single line. "
    "Keep each difference item on one line; separate multiple items with a semicolon and a space. "
